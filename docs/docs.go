...
const docTemplate = `{
    ...
    "paths": {
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/AchievementGrant",
                                        "summary": "body",
        ...
        "/user-achievements/{user_id}/{achievement_id}": {
            "delete": {
                "operationId": "revokeAchievement",
                "parameters": [
                    {
                        "description": "User ID",
                        "in": "path",
